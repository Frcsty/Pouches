package com.github.frcsty.pouches.utils.lib;
...
@SuppressWarnings({"unused" ,"unstable"})
public class ActionManager {
     ...
     */
    private ActionManager(final Plugin plugin, final boolean defaults) {
        this.plugin = plugin;
    ...
    private void unregister(final String id, final boolean aliases) {
    ...
    private void unregister(final List<String> actions, final boolean aliases) {
     ...
     * @param action action
     */
    private void execute(final Player player, final String action) {
     ...
     * @param action action
     */
    private void executeAsync(final Player player, final String action) {
     ...
     * @param actions actions list
     */
    private void executeAsync(final Player player, final List<String> actions) {
